...
export class News extends Component {
  ...
  async componentDidMount() {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=61ed1213cf3b4a03a5dcc646071b664a&page=1&pageSize=${this.props.pageSize}`;
  ...
  handleNext = async () => {
    ...
    &category=${this.props.category}&apiKey=61ed1213cf3b4a03a5dcc646071b664a&page=1&pageSize=${this.props.pageSize}`;
    this.setState({ loading: true });
    let data = await fetch(url);
    let parsedData = await data.json();
  ...
  handlePrev = async () => {
    ...
    &apiKey=61ed1213cf3b4a03a5dcc646071b664a&page=1&pageSize=${this.props.pageSize}`;
    this.setState({ loading: true });
    let data = await fetch(url);
    let parsedData = await data.json();
    console.log(parsedData);
